...
public class BaristaController {
    ...
    public Map<String, Object> getBaristaById(@PathVariable Long id) {
        Map<String, Object> response = new LinkedHashMap<>();
    ...
    public Map<String, Object> updateBarista(@PathVariable Long id, @RequestBody Barista newBarista) {
        Map<String, Object> response = new LinkedHashMap<>();
    ...
    public Map<String, Object> deleteBarista(@PathVariable Long id) {
        Map<String, Object> response = new LinkedHashMap<>();
